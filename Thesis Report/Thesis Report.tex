...
\usepackage[top=1in, bottom=1in, left=1.5in, right=1in]{geometry} %adjust margins. TODO: hack to fix large top margin
...
\newgeometry{top=1.5in, bottom=1in, left=1.5in, right=1in}

\begin{titlepage} %https://www.sharelatex.com/blog/2013/08/09/thesis-series-pt5.html
    \begin{center}
        \Huge
